...
/**
 * Implementation of the {@link ObjectIntVector} with an L1 (city-block) metric distance.
 * 
...
public class ObjectIntVectorL1 extends ObjectIntVector {
     ...
     */
    public ObjectIntVectorL1(int dimension, int min, int max) {
     ...
     */
    public ObjectIntVectorL1(BufferedReader stream) throws EOFException, IOException, NumberFormatException {
        super(stream);
    }
