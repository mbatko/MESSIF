 ...
 * </p>
 * <p>
 * Note that some database drivers (e.g. MySQL) will load the whole result set
 * into memory which might prove problematic for large tables and full-scan search.
 * This default behavior might be changed by providing additional parameters
 * to the connection URL or connection properties,
 * e.g. useCursorFetch=true&defaultFetchSize=1000 can be used for MySQL driver.
 * </p>
 *
    ...
    private class DatabaseStorageSearch<C> extends AbstractSearch<C, T> implements IntStorageSearch<T> {
        ...
        public boolean skip(int count) throws IllegalStateException {
            ...
            try {
                ...
                //Logger.getLogger(getClass().getName()).log(Level.WARNING, "Error skipping {0} objects from the underlying storage: {1}", new Object[]{count, e});
                return super.skip(count);
            }
        }
