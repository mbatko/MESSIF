...
/**
 * Provides a functionality of transforming (typically reducing) {@link Sequence sequences}.
 *
 ...
 */
public interface SequenceTransformer<T> {
    /**
     * Transforms the given sequence.
     * @param sequence the sequence to transform
     * @return the transformed data
     */
    public abstract T transform(Sequence<? extends T> sequence);
}
