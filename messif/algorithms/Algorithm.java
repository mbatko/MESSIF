...
public abstract class Algorithm implements Serializable {
    ...
    private transient ThreadLocal<MethodThreadList> bgExecutionList;
    ...
    private void initializeExecutor() throws IllegalArgumentException {
        ...
        bgExecutionList = new ThreadLocal<MethodThreadList>() {
            @Override
            protected synchronized MethodThreadList initialValue() {
                return new MethodThreadList(operationExecutor);
            }
        };
    }
