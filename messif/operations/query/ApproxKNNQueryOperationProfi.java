...
public class ApproxKNNQueryOperationProfi extends ApproxKNNQueryOperation {
    ...
    /**
     * Creates a new instance of ApproxKNNQueryOperationProfi
    ...
    public ApproxKNNQueryOperationProfi(MetaObjectProfiSCT queryObject, int k, int from,
        ...
        super(queryObject, k + from, answerType, localSearchParam, localSearchType, LocalAbstractObject.UNKNOWN_DISTANCE);
        if (from < 0)
    ...
    public String toString() {
        return new StringBuilder(" Profi search q=").append(getQueryObject().getLocatorURI()).append(" <from=").append(", k=").append(getK()).append("> ").
                append(" approx precision: ").append(localSearchParam).append(" ").append(localSearchType.toString()).toString();
//                .append("\n\tquery keywords: ").append(Arrays.toString(((MetaObjectProfiSCT) getQueryObject()).getKeyWords().getVectorData()))
//                .append("\n\tfirst obj kwrs: ").append(Arrays.toString(((MetaObjectProfiSCT) getAnswer().next().getObject()).getKeyWords().getVectorData())).append(" (locator=").append(getAnswer().next().getObject().getLocatorURI()).append(")")
//                .toString();
    }
