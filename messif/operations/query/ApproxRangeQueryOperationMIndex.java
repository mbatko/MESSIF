...
import messif.objects.util.RadiusRankedSortedCollection;
import messif.operations.AbstractOperation;
import messif.operations.AnswerType;

/**
 * Operation for approx. range on M-Index.
 * 
...
public class ApproxRangeQueryOperationMIndex extends ApproxKNNQueryOperationMIndex {
    ...
    /**
     * Operation constructor; the "k" is set to max, query radius is used via the interanal answer collection.
     * 
    ...
    public ApproxRangeQueryOperationMIndex(LocalAbstractObject queryObject, float queryRadius, float filteringRadius, int accessedObjects, AnswerType answerType) {
        ...
        this.setAnswerCollection(new RadiusRankedSortedCollection(queryRadius));
    }
}
