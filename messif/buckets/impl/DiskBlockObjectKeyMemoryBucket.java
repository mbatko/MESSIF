 ...
 * @see DiskBlockBucket
 */
public class DiskBlockObjectKeyMemoryBucket extends OrderedLocalBucket<AbstractObjectKey> implements Serializable {
     ...
     */
    public DiskBlockObjectKeyMemoryBucket(long capacity, long softCapacity, long lowOccupation, File file) throws IOException {
     ...
     * @throws IOException if there was a problem opening or creating the bucket file
     */
    public DiskBlockObjectKeyMemoryBucket(long capacity, long softCapacity, long lowOccupation, File file, int bufferSize, boolean directBuffers, boolean memoryMap, BinarySerializator serializator) throws IOException {
     ...
     */
    private DiskBlockObjectKeyMemoryBucket(long capacity, long softCapacity, long lowOccupation, boolean occupationAsBytes, DiskStorage<LocalAbstractObject> diskStorage) {
        super(capacity, softCapacity, lowOccupation, occupationAsBytes);
        objects = new LongStorageMemoryIndex<AbstractObjectKey, LocalAbstractObject>(diskStorage, LocalAbstractObjectOrder.keyToLocalObjectComparator);
    }
     ...
     */
    public static DiskBlockObjectKeyMemoryBucket getBucket(long capacity, long softCapacity, long lowOccupation, boolean occupationAsBytes, Map<String, Object> parameters) throws IOException, InstantiationException, ClassNotFoundException {
        return new DiskBlockObjectKeyMemoryBucket(capacity, softCapacity, lowOccupation, occupationAsBytes, DiskStorage.create(LocalAbstractObject.class, parameters));
    }
