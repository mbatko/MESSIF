 ...
 * @author xbatko
 */
public class DiskStorage<T> implements LongStorage<T>, Serializable {
    ...
    protected transient final ByteBufferFileInputStream inputStream;
     ...
     */
    public DiskStorage(Class<? extends T> storedObjectsClass, File file, int bufferSize, boolean bufferDirect, long startPosition, long maximalLength, BinarySerializator serializator) throws IOException {
    ...
    public static <T> DiskStorage<T> create(Class<T> storedObjectsClass, Map<String, Object> parameters) throws IOException, InstantiationException {
        ...
        return new DiskStorage<T>(storedObjectsClass, file, bufferSize, directBuffer, startPosition, maximalLength, serializator);
    }
    ...
    protected synchronized void reconstructHeader(FileChannel fileChannel, long position) throws IOException {
        ...
        ByteBufferFileInputStream reader = new ByteBufferFileInputStream(bufferSize, bufferDirect, fileChannel, position, maximalLength - headerSize);
        try {
    ...
    protected ByteBufferFileInputStream openInputStream() throws IOException {
        ...
        return new ByteBufferFileInputStream(bufferSize, bufferDirect, fileChannel, startPosition + headerSize, maximalLength - headerSize);
    }
    ...
    public synchronized void remove(long position) throws BucketStorageException {
        try {
            ...
            int size = serializator.skipObject(inputStream, false);
