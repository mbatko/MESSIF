...
public class AsynchronousFileChannelOutputStream extends BufferOutputStream {
    ...
    protected final AsynchronousFileChannel fileChannel;
     ...
     */
    public AsynchronousFileChannelOutputStream(int bufferSize, boolean bufferDirect, AsynchronousFileChannel fileChannel, long position, long maxLength) throws IOException {
    ...
    protected void write(ByteBuffer buffer) throws IOException {
        try {
            ...
            try {
                position += fileChannel.write(buffer, position).get();
