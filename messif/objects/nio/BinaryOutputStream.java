...
/**
 * Buffered output stream for binary serializator.
 * This is an abstract output stream that provides access to a 
 * {@link ByteBuffer} that is used in subclasses to flush the
 * data out. There are also two methods for requesting additional
 * space in the buffer.
 * 
 * 
