...
/**
 * Implementation of the {@link ObjectFloatVector} with an L2 (Euclidean) metric distance.
 * 
...
public class ObjectFloatVectorL2 extends ObjectFloatVector {
     ...
     */
    public ObjectFloatVectorL2(BufferedReader stream) throws EOFException, IOException, NumberFormatException {
        super(stream);
    }
