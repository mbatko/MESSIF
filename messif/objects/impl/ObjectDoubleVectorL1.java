...
/**
 * Implementation of the {@link ObjectDoubleVector} with an L1 (city-block) metric distance.
 * 
 * @author Michal Batko, Masaryk University, Brno, Czech Republic, batko@fi.muni.cz
 * @author Vlastislav Dohnal, Masaryk University, Brno, Czech Republic, dohnal@fi.muni.cz
 * @author David Novak, Masaryk University, Brno, Czech Republic, david.novak@fi.muni.cz
 */
public class ObjectDoubleVectorL1 extends ObjectDoubleVector {
     ...
     */
    public ObjectDoubleVectorL1(double[] data) {
        super(data);
    }
     ...
     */
    public ObjectDoubleVectorL1(int dimension, double min, double max) {
     ...
     */
    public ObjectDoubleVectorL1(BufferedReader stream) throws EOFException, IOException, NumberFormatException {
        super(stream);
    }
     ...
     */
    protected ObjectDoubleVectorL1(BinaryInput input, BinarySerializator serializator) throws IOException {
