...
public class ObjectShortVectorL1 extends ObjectShortVector {
    ...
    public ObjectShortVectorL1(BufferedReader stream) throws IOException, NumberFormatException {
        super(stream);
    }
     ...
     */
    protected ObjectShortVectorL1(BinaryInputStream input, BinarySerializator serializator) throws IOException {
