 ...
 * @author  xbatko
 */
public class ObjectVectorL1 extends ObjectVector {
    ...
    public ObjectVectorL1(float[] data) {
        super(data);
    }
    
    /** Creates a new instance of randomly generated object */
    public ObjectVectorL1(int dimension) {
        super(dimension);
    }

    /** Creates a new instance of object from stream */
    public ObjectVectorL1(BufferedReader stream) throws IOException, NumberFormatException {
        super(stream);
    }
    ...
    protected float getDistanceImpl(LocalAbstractObject obj, float distThreshold) {
        ...
        float[] objdata = ((ObjectVector)obj).data;
