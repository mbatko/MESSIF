...
public abstract class ObjectByteVector extends LocalAbstractObject implements BinarySerializable {
    ...
    /**
     * Creates a new instance of ObjectByteVector loaded from binary input stream.
     * 
     * @param input the stream to read the ObjectByteVector from
     * @param serializator the serializator used to write objects
     * @throws IOException if there was an I/O error reading from the stream
     */
    protected ObjectByteVector(BinaryInputStream input, BinarySerializator serializator) throws IOException {
