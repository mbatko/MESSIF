...
public class ObjectFeatureLongL2 extends ObjectFeatureLong implements BinarySerializable {
    ...
    public ObjectFeatureLongL2(BufferedReader stream) throws IOException, NumberFormatException {
        super(stream);
    }
    ...
    protected float getDistanceImpl(LocalAbstractObject obj, float distThreshold) {
        ...
        long [] objdata = ((ObjectFeatureLong)obj).data;
     ...
     */
    protected ObjectFeatureLongL2(BinaryInput input, BinarySerializator serializator) throws IOException {
